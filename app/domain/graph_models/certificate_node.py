    ...
    def from_sql_model(cls, certificate_model):
        ...
        if isinstance(certificate_model, dict):
            ...
            return cls(
                ...
                candidate_id=certificate_model.get('candidate_id'),
                exam_id=certificate_model.get('exam_id'),
            ...
            return cls(
                ...
                candidate_id=getattr(certificate_model, 'candidate_id', None),
                exam_id=getattr(certificate_model, 'exam_id', None),
